cc.Class({
    ...
    refreshBtns:function(){
        ...
        var dingpiao = prepare.getChildByName("dingpiao");

        dingpiao.active = isIdle && cc.vv.gameNetMgr.needDingPiao();
        waiting.active = isIdle && !dingpiao.active;
        actions.active = isIdle && !dingpiao.active && isOwner;
    },
    ...
    onBtnNotPiao: function() {
        cc.vv.net.send("dingpiao", 0);
    },
    
    onBtnPiao1Times: function() {
        cc.vv.net.send("dingpiao", 1);
    },
    
    onBtnPiao2Times: function() {
        cc.vv.net.send("dingpiao", 2);
    },
